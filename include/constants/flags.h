...
#define FLAG_HIDE_ROUTE101_WIERDKID  0x264
#define FLAG_LILYCOVE_MYSTERYGIFT_GIRL_SPOKEN  0x265
#define FLAG_LILYCOVE_MYSTERYGIFT_OUTLOOK_ACCESSIBLE  0x266
...
#define FLAG_BATTLE_SHOULD_AI_ESACAPE_FAIL     (SPECIAL_FLAGS_START + 0x5)
