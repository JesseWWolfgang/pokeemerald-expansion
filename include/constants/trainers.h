...
#define TRAINER_PICS_NORMAL_END           (TRAINER_PIC_RS_MAY)

#define TRAINER_PICS_EXTENED_MYSTERY_GIFT_START (TRAINER_PICS_NORMAL_END + 1)
#define TRAINER_PIC_SCIENTIST                   (TRAINER_PICS_EXTENED_MYSTERY_GIFT_START + 0) // 93
#define TRAINER_PICS_EXTENED_MYSTERY_GIFT_END   (TRAINER_PIC_SCIENTIST)
...
#define FACILITY_CLASSES_NORMAL_END          (FACILITY_CLASS_RS_MAY)

#define FACILITY_CLASSES_EXTENDED_MYSTERY_GIFT_START    (FACILITY_CLASSES_NORMAL_END + 1)
#define FACILITY_CLASS_SCIENTIST                        (FACILITY_CLASSES_EXTENDED_MYSTERY_GIFT_START + 0) // 0x52
#define FACILITY_CLASSES_EXTENDED_MYSTERY_GIFT_END      (FACILITY_CLASSES_NORMAL_END + 1)

#define FACILITY_CLASSES_ALL_END             (FACILITY_CLASSES_EXTENDED_MYSTERY_GIFT_END)
#define FACILITY_CLASSES_COUNT               (FACILITY_CLASSES_EXTENDED_MYSTERY_GIFT_END + 1) // 0x53
...
#define TRAINER_CLASSES_NORMAL_END  (TRAINER_CLASS_RS_PROTAG)

#define TRAINER_CLASSES_EXTENDED_MYSTERY_GIFT_START     (TRAINER_CLASSES_NORMAL_END + 1)
#define TRAINER_CLASS_SCIENTIST                         (TRAINER_CLASSES_EXTENDED_MYSTERY_GIFT_START + 0) // 0x42
#define TRAINER_CLASSES_EXTENDED_MYSTERY_GIFT_END       (TRAINER_CLASS_SCIENTIST)

#define TRAINER_CLASSES_ALL_END      (TRAINER_CLASSES_EXTENDED_MYSTERY_GIFT_END)
#define TRAINER_CLASS_COUNT          (TRAINER_CLASSES_ALL_END + 1) // 0x43
