...
#define MAPSEC_LIBERTY_GARDEN               (EXTENDED_MYSTERYGIFT_MAPSEC_START + 0) // 0xD5
#define MAPSEC_CASTELIA_CITY                (EXTENDED_MYSTERYGIFT_MAPSEC_START + 1) // 0xD6
#define MAPSEC_CAFE_SONATA                  (EXTENDED_MYSTERYGIFT_MAPSEC_START + 2) // 0xD7
#define MAPSEC_UNOVA_ROUTE_17               (EXTENDED_MYSTERYGIFT_MAPSEC_START + 3) // 0xD8
#define MAPSEC_P2_LABORATORY                (EXTENDED_MYSTERYGIFT_MAPSEC_START + 4) // 0xD9
#define MAPSEC_LUNAR_SUMMIT                 (EXTENDED_MYSTERYGIFT_MAPSEC_START + 5) // 0xDA
#define MAPSEC_EARTH                        (EXTENDED_MYSTERYGIFT_MAPSEC_START + 6) // 0xDB
#define EXTENDED_MYSTERYGIFT_MAPSEC_END     MAPSEC_EARTH  

#define MAPSEC_NONE                         (EXTENDED_MYSTERYGIFT_MAPSEC_END + 1) // 0xDB
