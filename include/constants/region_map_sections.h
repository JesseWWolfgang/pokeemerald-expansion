...
#define MAPSEC_CASTELIA_CITY                (EXTENDED_MYSTERYGIFT_MAPSEC_START + 1)
#define MAPSEC_CAFE_SONATA                  (EXTENDED_MYSTERYGIFT_MAPSEC_START + 2)
#define EXTENDED_MYSTERYGIFT_MAPSEC_END     MAPSEC_CAFE_SONATA  
