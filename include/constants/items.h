...
#define ITEM_EXTENDED_MYSTERY_GIFT_START (ITEM_GLIMMERING_CHARM + 1)
#define ITEM_LIBERTY_PASS       (ITEM_EXTENDED_MYSTERY_GIFT_START + 0) // 814
#define ITEM_WHITE_ROCK         (ITEM_EXTENDED_MYSTERY_GIFT_START + 1) // 815
