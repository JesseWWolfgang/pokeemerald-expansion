...
#define ITEM_EXTENDED_MYSTERY_GIFT_START    (ITEM_STELLAR_TERA_SHARD + 1)
#define ITEM_LIBERTY_PASS                   (ITEM_EXTENDED_MYSTERY_GIFT_START + 0) // 816
#define ITEM_WHITE_ROCK                     (ITEM_EXTENDED_MYSTERY_GIFT_START + 1) // 817
#define ITEM_EXTENDED_MYSTERY_GIFT_END      (ITEM_WHITE_ROCK)

#define ITEMS_COUNT     (ITEM_EXTENDED_MYSTERY_GIFT_END + 1) // 818
