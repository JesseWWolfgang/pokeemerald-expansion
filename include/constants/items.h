...
#define ITEM_EXTENDED_MYSTERY_GIFT_START    (ITEM_POKESHI_DOLL + 1)
#define ITEM_LIBERTY_PASS                   (ITEM_EXTENDED_MYSTERY_GIFT_START + 0) // 828
#define ITEM_WHITE_ROCK                     (ITEM_EXTENDED_MYSTERY_GIFT_START + 1) // 829
#define ITEM_EXTENDED_MYSTERY_GIFT_END      (ITEM_WHITE_ROCK)

#define ITEMS_COUNT     (ITEM_EXTENDED_MYSTERY_GIFT_END + 1) // 830
