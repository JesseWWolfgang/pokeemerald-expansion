...
#define MOVEMENT_TYPE_FORCE_ROTATE_COUNTERCLOCKWISE    0x51
#define MOVEMENT_TYPE_FORCE_ROTATE_CLOCKWISE           0x52
...
#define EXTENDED_MOVEMENT_ACTIONS_START                 (NORMAL_MOVEMENT_ACTIONS_END + 1)
#define MOVEMENT_ACTION_FORCE_FACE_DOWN                 (EXTENDED_MOVEMENT_ACTIONS_START + 0) // 0x9E
#define MOVEMENT_ACTION_FORCE_FACE_UP                   (EXTENDED_MOVEMENT_ACTIONS_START + 1) // 0x9F
#define MOVEMENT_ACTION_FORCE_FACE_LEFT                 (EXTENDED_MOVEMENT_ACTIONS_START + 2) // 0xA0
#define MOVEMENT_ACTION_FORCE_FACE_RIGHT                (EXTENDED_MOVEMENT_ACTIONS_START + 3) // 0xA1
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_UP_LEFT      (EXTENDED_MOVEMENT_ACTIONS_START + 4) // 0xA2
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_UP_RIGHT     (EXTENDED_MOVEMENT_ACTIONS_START + 5) // 0xA3
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_DOWN_LEFT    (EXTENDED_MOVEMENT_ACTIONS_START + 6) // 0xA4
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_DOWN_RIGHT   (EXTENDED_MOVEMENT_ACTIONS_START + 7) // 0xA5
#define MOVEMENT_ACTION_FACE_OBJECT                     (EXTENDED_MOVEMENT_ACTIONS_START + 8) // 0xA6
#define MOVEMENT_ACTION_FACE_AWAY_OBJECT                (EXTENDED_MOVEMENT_ACTIONS_START + 9) // 0xA7
#define EXTENDED_MOVEMENT_ACTIONS_END                   (MOVEMENT_ACTION_FACE_AWAY_OBJECT)
