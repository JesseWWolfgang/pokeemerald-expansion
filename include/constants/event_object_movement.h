...
#define NORMAL_MOVEMENT_TYPES_END                      (MOVEMENT_TYPE_WALK_SLOWLY_IN_PLACE_RIGHT)

#define ENHANCED_MOVEMENT_TYPES_START                  (NORMAL_MOVEMENT_TYPES_END + 1)
#define MOVEMENT_TYPE_FORCE_ROTATE_COUNTERCLOCKWISE    (ENHANCED_MOVEMENT_TYPES_START + 0) // 0x51
#define MOVEMENT_TYPE_FORCE_ROTATE_CLOCKWISE           (ENHANCED_MOVEMENT_TYPES_START + 1) // 0x52
#define MOVEMENT_TYPE_FACE_PLAYER                      (ENHANCED_MOVEMENT_TYPES_START + 2) // 0x53
#define ENHANCED_MOVEMENT_TYPES_END                    (MOVEMENT_TYPE_FACE_PLAYER)

#define ALL_MOVEMENT_TYPES_END                         (ENHANCED_MOVEMENT_TYPES_END)

#define NUM_MOVEMENT_TYPES                             (ALL_MOVEMENT_TYPES_END + 1) // 0x54
...
#define NORMAL_MOVEMENT_ACTIONS_END                     (MOVEMENT_ACTION_EMOTE_DOUBLE_EXCL_MARK)

#define ENHANCED_MOVEMENT_ACTIONS_START                 (NORMAL_MOVEMENT_ACTIONS_END + 1)
#define MOVEMENT_ACTION_FORCE_FACE_DOWN                 (ENHANCED_MOVEMENT_ACTIONS_START + 0)  // 0xA0
#define MOVEMENT_ACTION_FORCE_FACE_UP                   (ENHANCED_MOVEMENT_ACTIONS_START + 1)  // 0xA1
#define MOVEMENT_ACTION_FORCE_FACE_LEFT                 (ENHANCED_MOVEMENT_ACTIONS_START + 2)  // 0xA2
#define MOVEMENT_ACTION_FORCE_FACE_RIGHT                (ENHANCED_MOVEMENT_ACTIONS_START + 3)  // 0xA3
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_UP_LEFT      (ENHANCED_MOVEMENT_ACTIONS_START + 4)  // 0xA4
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_UP_RIGHT     (ENHANCED_MOVEMENT_ACTIONS_START + 5)  // 0xA5
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_DOWN_LEFT    (ENHANCED_MOVEMENT_ACTIONS_START + 6)  // 0xA6
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_DOWN_RIGHT   (ENHANCED_MOVEMENT_ACTIONS_START + 7)  // 0xA7
#define MOVEMENT_ACTION_FACE_OBJECT                     (ENHANCED_MOVEMENT_ACTIONS_START + 8)  // 0xA8
#define MOVEMENT_ACTION_FACE_AWAY_OBJECT                (ENHANCED_MOVEMENT_ACTIONS_START + 9)  // 0xA9
#define MOVEMENT_ACTION_WALK_IN_PLACE                   (ENHANCED_MOVEMENT_ACTIONS_START + 10) // 0xAA
#define MOVEMENT_ACTION_RUN_DOWN_SLOW                   (ENHANCED_MOVEMENT_ACTIONS_START + 11) // 0xAB
#define MOVEMENT_ACTION_RUN_UP_SLOW                     (ENHANCED_MOVEMENT_ACTIONS_START + 12) // 0xAC
#define MOVEMENT_ACTION_RUN_LEFT_SLOW                   (ENHANCED_MOVEMENT_ACTIONS_START + 13) // 0xAD
#define MOVEMENT_ACTION_RUN_RIGHT_SLOW                  (ENHANCED_MOVEMENT_ACTIONS_START + 14) // 0xAE
#define MOVEMENT_ACTION_WALK_FORWARD                    (ENHANCED_MOVEMENT_ACTIONS_START + 15) // 0xAF
#define MOVEMENT_ACTION_WALK_BACKWARD                   (ENHANCED_MOVEMENT_ACTIONS_START + 16) // 0xB0

#define ENHANCED_MOVEMENT_ACTIONS_END                   (MOVEMENT_ACTION_RUN_RIGHT_SLOW)
