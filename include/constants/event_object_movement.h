...
#define MOVEMENT_ACTION_FORCE_FACE_DOWN                 (ENHANCED_MOVEMENT_ACTIONS_START + 0)   // 0xA4
#define MOVEMENT_ACTION_FORCE_FACE_UP                   (ENHANCED_MOVEMENT_ACTIONS_START + 1)   // 0xA5
#define MOVEMENT_ACTION_FORCE_FACE_LEFT                 (ENHANCED_MOVEMENT_ACTIONS_START + 2)   // 0xA6
#define MOVEMENT_ACTION_FORCE_FACE_RIGHT                (ENHANCED_MOVEMENT_ACTIONS_START + 3)   // 0xA7
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_UP_LEFT      (ENHANCED_MOVEMENT_ACTIONS_START + 4)   // 0xA8
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_UP_RIGHT     (ENHANCED_MOVEMENT_ACTIONS_START + 5)   // 0xA9
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_DOWN_LEFT    (ENHANCED_MOVEMENT_ACTIONS_START + 6)   // 0xAA
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_DOWN_RIGHT   (ENHANCED_MOVEMENT_ACTIONS_START + 7)   // 0xAB
#define MOVEMENT_ACTION_FACE_OBJECT                     (ENHANCED_MOVEMENT_ACTIONS_START + 8)   // 0xAC
#define MOVEMENT_ACTION_FACE_AWAY_OBJECT                (ENHANCED_MOVEMENT_ACTIONS_START + 9)   // 0xAD
#define MOVEMENT_ACTION_WALK_IN_PLACE                   (ENHANCED_MOVEMENT_ACTIONS_START + 10)  // 0xAE
