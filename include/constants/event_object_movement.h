...
#define MOVEMENT_ACTION_FORCE_FACE_DOWN                 (EXTENDED_MOVEMENT_ACTIONS_START + 0)
#define MOVEMENT_ACTION_FORCE_FACE_UP                   (EXTENDED_MOVEMENT_ACTIONS_START + 1)
#define MOVEMENT_ACTION_FORCE_FACE_LEFT                 (EXTENDED_MOVEMENT_ACTIONS_START + 2)
#define MOVEMENT_ACTION_FORCE_FACE_RIGHT                (EXTENDED_MOVEMENT_ACTIONS_START + 3)
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_UP_LEFT      (EXTENDED_MOVEMENT_ACTIONS_START + 4)
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_UP_RIGHT     (EXTENDED_MOVEMENT_ACTIONS_START + 5)
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_DOWN_LEFT    (EXTENDED_MOVEMENT_ACTIONS_START + 6)
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_DOWN_RIGHT   (EXTENDED_MOVEMENT_ACTIONS_START + 7)
#define EXTENDED_MOVEMENT_ACTIONS_END                   (MOVEMENT_ACTION_WALK_FAST_DIAGONAL_DOWN_RIGHT)
