...
#ifdef MUSIC_EXPANSION

#define MUS_LIBERTY_GARDEN_EXTERIOR         MUS_BW_ROUTE6_SUMMER
#define MUS_LIBERTY_GARDEN_INTERIOR         MUS_BW_COLD_STORAGE
#define MUS_CASTELIA_CITY_LIBERTY_PIER      MUS_BW_CASTELIA
#define MUS_UNOVA_ROUTE_17                  MUS_BW_ROUTE6_SUMMER
#define MUS_P2_LABORATORY                   MUS_BW_COLD_STORAGE

#define MUS_CAFE_SONATA_RELIC_SONG          MUS_BW_RELIC_SONG

#define MUS_UNOVA_WILD                      MUS_BW_VS_WILD
...
#define MUS_LIBERTY_GARDEN_EXTERIOR         MUS_RG_SEVII_ROUTE
#define MUS_LIBERTY_GARDEN_INTERIOR         MUS_RG_POKE_MANSION
#define MUS_CASTELIA_CITY_LIBERTY_PIER      MUS_RG_FUCHSIA
#define MUS_UNOVA_ROUTE_17                  MUS_ROUTE119
#define MUS_P2_LABORATORY                   MUS_RG_ROCKET_HIDEOUT

#define MUS_CAFE_SONATA_RELIC_SONG          MUS_C_COMM_CENTER

#define MUS_UNOVA_WILD                      MUS_RG_VS_WILD
...
#define MUS_UNOVA_VS_PLASMA                 MUS_VS_AQUA_MAGMA
