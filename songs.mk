...
$(MID_SUBDIR)/mus_evolution_intro.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G026 -V080 -P5
...
$(MID_SUBDIR)/mus_dp_valor_lakefront_day.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G191 -V096 -X
...
$(MID_SUBDIR)/mus_dp_valor_lakefront_night.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G191 -V095 -X
...
$(MID_SUBDIR)/mus_hg_radio_rocket.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G229 -V092 -X
...
$(MID_SUBDIR)/mus_hg_radio_unown.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G229 -V089 -X
...
$(MID_SUBDIR)/mus_hg_b_arcade.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G229 -V077 -X
...
$(MID_SUBDIR)/mus_bw_lacunosa.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G274 -V090 -X
...
$(MID_SUBDIR)/mus_bw_driftveil_drawbridge.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G274 -V124 -X
...
$(MID_SUBDIR)/mus_bw_feeling_check_3.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G274 -V066 -p5
...
$(MID_SUBDIR)/mus_bw_feeling_check_start.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G274 -V110 -p5
...
$(MID_SUBDIR)/mus_b2_pokestar_studios_defeat.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G274 -V114

$(MID_SUBDIR)/mus_b2_pokestar_studios_invasion.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G274 -V125
...
$(MID_SUBDIR)/mus_b2_mistralton_gym.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G274 -V102

$(MID_SUBDIR)/mus_b2_humilau_gym.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G274 -V122
...
$(MID_SUBDIR)/mus_b2_tympole_choir.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G274 -V100 -p5

$(MID_SUBDIR)/mus_b2_join_avenue_rank_up_1.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G274 -V120 -p5
