...
static const union AnimCmd sAnim_RocketStop[] =
{
    ANIMCMD_FRAME(0, 4),
    ANIMCMD_JUMP(0),
};
...
static const union AnimCmd sAnim_RocketTakeoff[] =
{
    ANIMCMD_FRAME(1, 2),
    ANIMCMD_FRAME(2, 2),
    ANIMCMD_FRAME(1, 2),
...
static const union AnimCmd *const sAnimTable_Rocket[] = {
    [ANIM_STD_FACE_SOUTH] = sAnim_RocketStop,
    [ANIM_STD_FACE_NORTH] = sAnim_RocketStop,
    [ANIM_STD_FACE_WEST] = sAnim_RocketStop,
    [ANIM_STD_FACE_EAST] = sAnim_RocketStop,
    [ANIM_STD_GO_SOUTH] = sAnim_RocketTakeoff,
    [ANIM_STD_GO_NORTH] = sAnim_RocketTakeoff,
    [ANIM_STD_GO_WEST] = sAnim_RocketTakeoff,
    [ANIM_STD_GO_EAST] = sAnim_RocketTakeoff,
    [ANIM_STD_GO_FAST_SOUTH] = sAnim_RocketTakeoff,
    [ANIM_STD_GO_FAST_NORTH] = sAnim_RocketTakeoff,
    [ANIM_STD_GO_FAST_WEST] = sAnim_RocketTakeoff,
    [ANIM_STD_GO_FAST_EAST] = sAnim_RocketTakeoff,
    [ANIM_STD_GO_FASTER_SOUTH] = sAnim_RocketTakeoff,
    [ANIM_STD_GO_FASTER_NORTH] = sAnim_RocketTakeoff,
    [ANIM_STD_GO_FASTER_WEST] = sAnim_RocketTakeoff,
    [ANIM_STD_GO_FASTER_EAST] = sAnim_RocketTakeoff,
    [ANIM_STD_GO_FASTEST_SOUTH] = sAnim_RocketTakeoff,
    [ANIM_STD_GO_FASTEST_NORTH] = sAnim_RocketTakeoff,
    [ANIM_STD_GO_FASTEST_WEST] = sAnim_RocketTakeoff,
    [ANIM_STD_GO_FASTEST_EAST] = sAnim_RocketTakeoff,
};