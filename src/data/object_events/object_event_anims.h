...
static const union AnimCmd *const sAnimTable_Rocket[] = {
    ...
    [ANIM_STD_GO_FASTER_SOUTH] = sAnim_RocketStop,
    ...
    [ANIM_STD_GO_FASTEST_SOUTH] = sAnim_RocketStop,
