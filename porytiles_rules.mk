...
PRIMARY_TILESET_PATHS := $(patsubst %, $(METATILES_DIR)/primary/%/, $(PRIMARY_TILESET_NAMES))
PRIMARY_TARGETS := $(foreach P, $(PRIMARY_TILESET_PATHS), $(addprefix $(P), $(DEST_NAMES)))

SECONDARY_TILESET_PATHS := $(patsubst %, $(METATILES_DIR)/secondary/%/, $(SECONDARY_TILESET_NAMES))
...
$(addprefix $(METATILES_DIR)/primary/porytiles_test/, $(DEST_NAMES)) &: $(shell find $(PORYTILES_DIR)/primary/porytiles_test)
	$(PORYTILES_BINARY) compile-primary -o $(METATILES_DIR)/primary/porytiles_test $(PORYTILES_DIR)/primary/porytiles_test

$(addprefix $(METATILES_DIR)/primary/porytiles_test2/, $(DEST_NAMES)) &: $(shell find $(PORYTILES_DIR)/primary/porytiles_test2)
	$(PORYTILES_BINARY) compile-primary -o $(METATILES_DIR)/primary/porytiles_test2 $(PORYTILES_DIR)/primary/porytiles_test2

# Secondary

$(addprefix $(METATILES_DIR)/secondary/porytiles_test_secondary/, $(DEST_NAMES)) &: $(shell find $(PORYTILES_DIR)/secondary/porytiles_test_secondary)
