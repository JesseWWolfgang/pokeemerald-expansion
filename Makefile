...
SCRIPT := tools/pory/poryscript$(EXE)
...
override CFLAGS += -mthumb-interwork -Wimplicit -Wparentheses -Werror $(OPTIMIZE) -fhex-asm -g
ROM := $(ROM_NAME)
...
override CFLAGS += -mthumb -mthumb-interwork $(OPTIMIZE) -mabi=apcs-gnu -mtune=arm7tdmi -march=armv4t -fno-toplevel-reorder -Wno-pointer-to-int-cast -std=gnu17 ${USE_ANALYSER} -Werror -Wall -Wno-strict-aliasing -Wno-attribute-alias -Woverride-init
ifeq ($(ANALYZE),1)
